        ...
        <>
          <section className="space-y-4">
            <div className="panel rounded-3xl p-6">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-muted-foreground">
                    Esta tabla se arma con los resultados cargados. Cuando un grupo termina, aqui mismo se marcan oficialmente los 2 clasificados y los mejores terceros que ya quedaron definidos.
                  </p>
                </div>
                {data.breakdown ? (
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              {data.standingsOverview?.groups?.map((group: any) => (
                    ...
                    <table className="min-w-full text-sm">
                      ...
                      <tbody>
                        {group.rows.map((team: any) => (
                          <tr key={`table-${group.group}-${team._id}`} className="border-t border-border/60">
